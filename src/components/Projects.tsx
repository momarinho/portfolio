...
export function Projects() {
    ...
    const projectsData = [
        ...
        {
            id: "proposal-engine",
            stack: "Python, NLP, Template Engine",
            link: "https://github.com/momarinho/proposal_engine_doe",
            translation: t.projects.items.proposalEngine
        },
        {
            id: "deep-research",
            stack: "Agentic AI, Web Search",
            link: "https://github.com/momarinho/deep_research_sales_builder",
            translation: t.projects.items.deepResearch
        },
        {
            id: "seo-analyzer",
            stack: "Python, SEO APIs, Agents",
            link: "https://github.com/momarinho/agentic_seo_analyzer",
            translation: t.projects.items.seoAnalyzer
        },
        {
            id: "fractal-ride",
            stack: "Next.js, TypeScript, Checkout",
    ...
    return (
        <section id="projects" className="py-12 md:py-20 px-4 max-w-6xl mx-auto">
            <div className="flex items-center gap-4 mb-12">
                <h2 className="font-press-start text-2xl md:text-3xl text-[#ffd700]">{t.projects.title}</h2>
                <div className="h-1 bg-gray-700 flex-grow"></div>
                <span className="font-vt323 text-xl text-gray-500">{projectsData.length} {t.common.activeQuests}</span>
            </div>

            <div className="grid md:grid-cols-2 gap-8">
                {projectsData.map((project) => (
                    <div key={project.id} className="pixel-card bg-[#1a1a2e] p-6 group hover:bg-[#20203a] transition-colors">
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <div className="bg-[#b026ff] text-black text-xs px-2 py-1 font-bold">
                                {t.common.xp} +500
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex flex-wrap gap-2">
                                {project.translation.bullets.map((bullet, i) => (
                                    <span key={i} className="text-xs bg-gray-800 text-gray-300 px-2 py-1 border border-gray-600">
                                        {bullet}
                                    </span>
                                ))}
                            </div>
                            ...
                            <div className="flex items-center justify-between pt-4 border-t border-gray-700">
                                ...
                                <a
                                    ...
                                    rel="noreferrer"
                                    onClick={playClick}
                                    className="flex items-center gap-2 text-white hover:text-[#ffd700] transition-colors font-press-start text-xs"
                                >
                                    <Github size={16} />
                                    {t.common.viewQuest}
                                </a>
