                ...
                <div className="grid md:grid-cols-2 gap-8 md:gap-12">
                    ...
                    <div className="font-vt323 text-xl md:text-2xl space-y-6">
                        <div className="bg-[#050510] p-4 border border-gray-700">
                            <p className="text-[#39ff14] mb-2">{">"} {t.character.classLabel}: {t.hud.class}</p>
                            <p className="text-[#00f3ff] mb-2">{">"} {t.character.specialtyLabel}: Python, AI, DOE</p>
                            <p className="text-gray-400">{">"} {t.character.bioLabel}:</p>
                        ...
                        <div className="bg-[#050510] p-4 border border-gray-700">
                            <span className="text-yellow-400">{t.character.currentStatus}:</span> {t.character.statusValue}
                        </div>
                    </div>

                    {/* Right Column: Stats */}
                    <div className="space-y-4 font-vt323 text-xl">
                        <h3 className="text-[#b026ff] text-2xl mb-4 text-center decoration-wavy underline">{t.character.attributesTitle}</h3>
                        {stats.map((stat) => (
                            <div key={stat.label}>
